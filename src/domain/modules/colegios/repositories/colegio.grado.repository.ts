...
export abstract class ColegioGradoRepository {
    ...
    // abstract findByIdAllNivel(id:string):Promise<ColegioGradoEntityOu>;
    ...
    abstract updateIsActive(udateColegioGradoDto:UpdateColegioGradoDto,by:string): Promise<ColegioGradoEntityOu>;
}