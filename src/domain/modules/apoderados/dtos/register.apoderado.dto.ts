export class RegisterApoderadoDto {
    ...
    static create(object:{[key:string]:any}):[string?,RegisterApoderadoDto?]{
        ...
        return [
            undefined,
            new RegisterApoderadoDto( id_colegio, nombre, paterno,materno, id_documento, nro_documento,id_genero,correo,telefono,object.fecha_nacimiento,object.direccion,object.foto ),
        ]
    }
}