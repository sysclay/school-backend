...
export class RegisterAsistenciaEstadoDto {
    private constructor (
    ...
    static create(object:{[key:string]:any}):[string?,RegisterAsistenciaEstadoDto?]{
        ...
        return [ 
            undefined,
            new RegisterAsistenciaEstadoDto(matricula_id, hora_entrada, hora_entrada, registrador_entrada, hora_entrada ),
        ]
    }
}