export class RegisterDirectorDto {
    ...
    static create(object:{[key:string]:any}):[string?,RegisterDirectorDto?]{
        ...
        return [
            undefined,
            new RegisterDirectorDto( id_colegio, nombre, paterno,materno, id_documento, nro_documento,id_genero,correo,telefono,object.fecha_nacimiento,object.direccion,object.foto ),
        ]
    }
}