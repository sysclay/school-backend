...
import { memoryImagesFotos } from "../../../middlewares/MemoryImg.js";
...
export class FileRoutes {
    static get routes(): Router {
        ...
        // Solo imágenes
        router.post('/register-foto',authMiddleware, memoryImagesFotos().single('file'),  controller.registerCloudinary );
